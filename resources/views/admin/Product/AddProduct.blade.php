            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('ProductStore')}}" method="post" enctype="multipart/form-data">
                        @csrf()
                      <div class="form-group">
                        <label for="exampleInputName1">Product Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter First Name" name="name">
                      </div>
                      @if($errors->has('name'))
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter First Name" name="description">
                      </div>
                      @if($errors->has('description'))
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Price" name="price">
                      </div>
                      @if($errors->has('price'))
                      ...
                      @if($errors->has('image'))
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Color" name="color">
                      </div>
                      @if($errors->has('color'))
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Size" name="size">
                      </div>
                      @if($errors->has('size'))
