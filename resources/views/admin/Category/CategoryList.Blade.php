                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-hover" id="example1" width="100%">
                      <thead>
                      <tr class="text-center"><a href="{{route('categorydata')}}" class="btn btn-secondary" role="button">ADD Data</a></tr>
                        <tr>
                      ...
                      @foreach ($categorydata as $category)
                            <tr>
                                ...
                                <td class="text-center"><a href="EditCategory/{{ $category['id'] }}" class="btn btn-info" role="button">Edit </a> 
                                 <a  href="javascript:void(0)" class="btn btn-danger dtlpro" aid="{{ $category['id'] }}"  role="button"> Delete</a></td>
                            </tr>
                        @endforeach
                      </tbody>
                    </table>
            ...
            <script>
                $(document).ready(function(){
                    $(".dtlpro").click(function(e){
                        ...
                        if(confirm(" Your Category Data will be deleted !!")){
                            //alert(aid);
                            $.ajax({
