            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('CouponStore')}}" method="post">
                        @csrf()
                      <div class="form-group">
                        <label for="exampleInputName1">Code</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter First Name" name="code">
                      </div>
                      @if($errors->has('code'))
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Last Name" name="value">
                      </div>
                      @if($errors->has('value'))
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Last Name" name="cart_value">
                      </div>
