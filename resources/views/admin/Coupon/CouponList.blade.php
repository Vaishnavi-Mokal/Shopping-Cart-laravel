                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-hover" id="example1" width="100%">
                      <thead>
                      <tr class="text-center"><a href="{{route('CouponAdd')}}" class="btn btn-success btnn" role="button">ADD Coupon</a></tr>
                        <tr>
                      ...
                      @foreach ($coupons as $coupon)
                            <tr>
                                ...
                                <td class="text-center"><a href="{{url('EditCoupon/'.$coupon->id)}}" class="btn btn-info" role="button">Edit </a>  <a  href="javascript:void(0)" class="btn btn-danger dtlpro" aid="{{ $coupon['id'] }}"  role="button"> Delete</a></td>
                            </tr>
                        @endforeach
                      </tbody>
                    </table>
            ...
            <script>
                $(document).ready(function(){
                    $(".dtlpro").click(function(e){
                        ...
                        if(confirm(" Your Coupon will be deleted !!")){
                            //alert(aid);
                            $.ajax({
